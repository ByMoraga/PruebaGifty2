...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.activity_cliente_agregar) {
            FragmentManager fragmentManager = getSupportFragmentManager();
            fragmentManager.beginTransaction().replace(R.id.content_main, new AgregarClienteActivity()).commit();
            return true;
        } else if (id == R.id.listarCliente) {
            FragmentManager fragmentManager = getSupportFragmentManager();
            fragmentManager.beginTransaction().replace(R.id.content_main, new ListarClienteActivity()).commit();
            return true;
        } else if (id == R.id.eliminarCliente) {
            FragmentManager fragmentManager = getSupportFragmentManager();
            fragmentManager.beginTransaction().replace(R.id.content_main, new EliminarClienteActivity()).commit();
            return true;
